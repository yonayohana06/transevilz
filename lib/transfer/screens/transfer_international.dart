...
class TransferInter extends StatelessWidget {
  const TransferInter({super.key, required this.type});
            ...
            children: [
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  validator: context.read<TransferBloc>().validateInter,
                ),
              ),
              Container(
              ...
              Container(
                ...
                child: TextFormField(
                  autovalidateMode: AutovalidateMode.onUserInteraction,
                  controller: context.read<TransferBloc>().amountUSD,
                  decoration: InputDecoration(
                    contentPadding: const EdgeInsets.all(10),
                    fillColor: const Color(0xFFE5F2FF),
                    filled: true,
